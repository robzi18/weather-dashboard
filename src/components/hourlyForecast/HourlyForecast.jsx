      ...
      <div className="main-weather-info">
        <div className="left-side">
          ...
          <div className="next-day-forecast">
            <div className='next-day-wrapper'>
              ...
              <h1>{`${isCel ? forecast?.forecastday[1]?.day?.avgtemp_c + " °C" :  forecast?.forecastday[1]?.day?.avgtemp_f + " °F"}`}</h1>
              <img src={forecast?.forecastday[1]?.day?.condition?.icon} alt={forecast?.forecastday[1]?.day?.condition?.text}/>
        ...
        <div className="right-side">
          <div className="current-feature">
            <p>Sunrise</p>
            <h1 className="hour"> {forecast?.forecastday[1]?.astro?.sunrise}</h1>
          </div>
          <div className="current-feature">
            <p>Sunset</p>
          ...
          <div className="current-feature">
            <p>Length of day</p>
            <h1 className="length"> {(forecast?.forecastday[1]?.astro?.sunrise).split(":")[0]}
